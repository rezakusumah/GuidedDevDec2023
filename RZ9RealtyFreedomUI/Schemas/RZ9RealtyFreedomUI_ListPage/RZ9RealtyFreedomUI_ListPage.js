define("RZ9RealtyFreedomUI_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "RZ9RealtyFreedomUI",
					"layoutConfig": {
						"width": 328.125
					},
		...
		modelConfig: /**SCHEMA_MODEL_CONFIG*/{
			"dataSources": {
				"PDS": {
					...
					"config": {
						"entitySchemaName": "RZ9RealtyFreedomUI"
					},
					"scope": "viewElement"
				}
			}
